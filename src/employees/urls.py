...
urlpatterns = [
    ...
    path('<slug:slug>/documents/', views.EmployeeDocumentList.as_view(), name='employee-document-list'),
    path('<slug:slug>/documents/new', views.EmployeeDocumentCreate.as_view(), name='employee-document-create'),
    path('<slug:slug>/documents/<int:pk>/', views.EmployeeDocumentDetail.as_view(), name='employee-document-detail'),
    ...
    path('<slug:slug>/rate/', views.EmployeeRateList.as_view(), name='employee-rate-list'),
